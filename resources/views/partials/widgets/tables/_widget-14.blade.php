						...
						<td>
							<div class="d-flex align-items-center">
								...
								<div class="d-flex justify-content-start flex-column">
									<a href="{{ route('company1') }}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">1Office</a>
									<span class="text-gray-400 fw-semibold d-block fs-7">Korrie Van Kaam</span>
								</div>
							</div>
						</td>
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								...
								<div class="d-flex justify-content-start flex-column">
									<a href="{{ route('company2') }}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Group Burial Association</a>
